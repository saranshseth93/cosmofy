        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl opacity-80 max-w-2xl mx-auto">
              Track geomagnetic activity and discover the best times and
              locations to witness the spectacular aurora displays.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="glass-effect rounded-2xl">
              <CardContent className="p-8">
                ...
                <div className="bg-[hsl(222,47%,8%)] bg-opacity-30 rounded-xl p-6 mt-6">
