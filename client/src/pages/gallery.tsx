...
import { Calendar, Star, Rocket, Globe, ChevronLeft, ChevronRight, Eye, Download, Share } from 'lucide-react';
              ...
              {images?.map((image, index) => (
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    {image.copyright && (
                      <Badge variant="outline" className="mt-3 border-gray-600/50 text-gray-400">
                        © {image.copyright}
                      </Badge>
                    )}
                  </CardContent>
        ...
        >
          ...
          >
            ...
            <div className="p-6 overflow-y-auto max-h-[40vh]">
              ...
              <p className="text-gray-300 leading-relaxed">{selectedImage.explanation}</p>
              
              {selectedImage.copyright && (
                <Badge variant="outline" className="mt-4 border-gray-600/50 text-gray-400">
                  © {selectedImage.copyright}
                </Badge>
              )}
            </div>
